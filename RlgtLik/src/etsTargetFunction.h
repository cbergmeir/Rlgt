...
private:
	...
	double alpha, beta, gamma, phi, lambda, rho;
	...
	bool optAlpha, optBeta, optGamma, optPhi, optLambda, optRho;
	bool givenAlpha, givenBeta, givenGamma, givenPhi, givenLambda, givenRho;
