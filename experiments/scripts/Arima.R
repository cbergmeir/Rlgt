...
saveRDS(sMAPE, "results/Arima - sMAPE.yearly.rds")
saveRDS(MASE, "results/Arima - MASE.yearly.rds")
# saveRDS(forecasts, "results/Arima - forecasts.yearly.rds")
...
print(paste("sMAPE:", mean(sMAPE), ", MASE:", mean(MASE)))
print(paste("time difference:", end.time-start.time, attr(end.time-start.time, "units")))
saveRDS(sMAPE, "results/Arima - sMAPE.monthly.rds")
saveRDS(MASE, "results/Arima - MASE.monthly.rds")
# saveRDS(forecasts, "results/Arima - forecasts.monthly.rds")
...
print(paste("sMAPE:", mean(sMAPE), ", MASE:", mean(MASE)))
print(paste("time difference:", end.time-start.time, attr(end.time-start.time, "units")))
saveRDS(sMAPE, "results/Arima - sMAPE.quarterly.rds")
saveRDS(MASE, "results/Arima - MASE.quarterly.rds")
# saveRDS(forecasts, "results/Arima - forecasts.quarterly.rds")